...
import md5 from 'md5';
import { Grid, Form, Header,Icon,Segment, Button,Message} from 
'semantic-ui-react';
    ...
    render(){
        ...
        return(
           <Grid textAlign="center" verticalAlign="middle" className="app">
               <Grid.Column style={{ maxWidth :540 }}>
                   ...
                   <Form onSubmit={this.handleSubmit} size="large">
                       <Segment stacked>
                          ...
                          <Form.Input fluid name="email" icon="mail" iconPosition="left"
                           ...
                           placeholder="passwordConfirmation" onChange={this.handleChange} value={passwordConfirmation} className={this.handleInputError(errors, 'password') } type="password" />
